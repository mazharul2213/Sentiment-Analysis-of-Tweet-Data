rm(list = ls())
setwd("G:\\msc\\Final Project\\Twitter Sentiment Analysis")
...
source("G:\\msc\\Final Project\\Twitter Sentiment Analysis\\totalcleanupneeded.R")

#including the  clean up function 
# source("cleanuptweets.R")

source("G:\\msc\\Final Project\\Twitter Sentiment Analysis\\cleanuptweets.R")
#including the source that has word cloud function 

source("G:\\msc\\Final Project\\Twitter Sentiment Analysis\\wordcloud.R")
